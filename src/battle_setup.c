...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_GRETA_G1, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, MAP_RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_LUCY_G2, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, MAP_DEWFORD_TOWN),
    ...
    [REMATCH_WINONA] = REMATCH(TRAINER_NOLAND_G6, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, MAP_FORTREE_CITY),
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_TUCKER_G8, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, MAP_SOOTOPOLIS_CITY),
    [REMATCH_SIDNEY] = REMATCH(TRAINER_LOWTIERGODE4, TRAINER_LOWTIERGODE4, TRAINER_LOWTIERGODE4, TRAINER_LOWTIERGODE4, TRAINER_LOWTIERGODE4, MAP_EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_WHITNEY, TRAINER_WHITNEY, TRAINER_WHITNEY, TRAINER_WHITNEY, TRAINER_WHITNEY, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_STEVENE4, TRAINER_STEVENE4, TRAINER_STEVENE4, TRAINER_STEVENE4, TRAINER_STEVENE4, MAP_EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, MAP_EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_LANDEEZ, TRAINER_LANDEEZ, TRAINER_LANDEEZ, TRAINER_LANDEEZ, TRAINER_LANDEEZ, MAP_EVER_GRANDE_CITY),
};
