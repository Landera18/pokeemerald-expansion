...
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM_SMART_STRIKE,     ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListAttract[]     = {ITEM_TM_FEINT_ATTACK,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
