...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_PRANKSTER, ABILITY_WONDER_SKIN },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_WONDER_SKIN },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_CHLOROPHYLL, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_CLAYDOL}),
    },
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_HUNTAIL},
