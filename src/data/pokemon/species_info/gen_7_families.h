...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_NONE, ABILITY_LONG_REACH },
    ...
    [SPECIES_DECIDUEYE_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_NONE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Decidueye"),
        .cryId = CRY_DECIDUEYE,
        .natDexNum = NATIONAL_DEX_DECIDUEYE,
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_LYCANROC_MIDNIGHT, CONDITIONS({IF_PID_UPPER_MODULO_10_GT, 4})},
                                {EVO_LEVEL, 20, SPECIES_LYCANROC_MIDDAY, CONDITIONS({IF_PID_UPPER_MODULO_10_LT, 5})},
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_SALAZZLE},
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_COSMOEM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 70, SPECIES_SOLGALEO, CONDITIONS({IF_PID_UPPER_MODULO_10_GT, 4})},
                                {EVO_LEVEL, 70, SPECIES_LUNALA, CONDITIONS({IF_PID_UPPER_MODULO_10_LT, 5})}),
    },
    ...
    [SPECIES_BUZZWOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BIG_PECKS, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_XURKITREE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_KARTANA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MAGEARNA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_NONE, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STAKATAKA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STALWART, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
