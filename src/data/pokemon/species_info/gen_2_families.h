...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_NATU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_XATU}),
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 13, SPECIES_SKIPLOOM}),
    },
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_SUNFLORA}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_KEEN_EYE, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_URSALUNA, CONDITIONS({IF_PID_UPPER_MODULO_10_GT, 4})},
                                {EVO_LEVEL, 52, SPECIES_URSALUNA_BLOODMOON, CONDITIONS({IF_PID_UPPER_MODULO_10_LT, 5})}),
    #endif
    },
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    #if P_GEN_8_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_WYRDEER}),
    #endif
    },
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_TYRANITAR}),
    },
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_BULLETPROOF, ABILITY_UNNERVE, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GREEN,
