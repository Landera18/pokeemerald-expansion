...
// Medicine
    ...
    [ITEM_HYPER_POTION] =
    {
        ...
        .price = (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 20 : 20,
        .holdEffectParam = 120,
        .description = COMPOUND_STRING(
            "Restores the HP of\n"
            "a Pokémon by\n"
